    ...
    .config(function ($stateProvider) {
        $stateProvider
            .state('message', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'mytestApp.message.home.title'
                },
                views: {
                    'content@': {
            ...
            .state('message.detail', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'mytestApp.message.detail.title'
                },
                views: {
                    'content@': {
            ...
            .state('message.new', {
                ...
                onEnter: ['$stateParams', '$state', '$modal', function($stateParams, $state, $modal) {
                    $modal.open({
                        ...
                        resolve: {
                            entity: function () {
                                return {email: null, messageText: null, name: null, startDate: null, endDate: null, id: null};
                            }
                        }
